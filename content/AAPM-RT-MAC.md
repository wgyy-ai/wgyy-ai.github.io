---
dataset_entry: true
dataset_name: AAPM-RT-MAC
dataset_path: 1-Dataset/AAPM-RT-MAC.md
dimensions: 3D
modality: MRI
task_type: Segmentation
anatomical_structures: Salivary Glands, Lymph Nodes
anatomical_area: Head and Neck
number_of_categories: "8"
data_volume: "55"
file_format: .dcm
source_url: https://www.cancerimagingarchive.net/collection/aapm-rt-mac/
...
| Label | Anatomical Structure                | Cases | Segmentation Accuracy | Average Volume (cm椴? | Min Volume (cm椴? | Max Volume (cm椴? |
|-------|-------------------------------------|-------|-----------------------|----------------------|------------------|------------------|
