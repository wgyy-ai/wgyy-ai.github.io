...
data_volume: "628"
file_format: ".dcm"
source_url: "https://www.cancerimagingarchive.net/collection/hcc-tace-seg/"
...
| Anatomy     | Total Cases | Coverage | Minimum Volume (cm鲁)  | Median Volume (cm鲁) | Maximum Volume (cm鲁) |
|-------------|-------------|----------|-----------------------|---------------------|----------------------|
