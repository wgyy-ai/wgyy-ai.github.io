...
dataset_entry: true
dataset_name: "VerSe"
dataset_path: "1-Dataset/VerSe.md"
dimensions: "3D"
modality: "CT"
task_type: "Segmentation"
anatomical_structures: "Vertebrae"
anatomical_area: "Vertebrae"
number_of_categories: "26"
data_volume: "141 for training, 120 for validation, 113 for test"
file_format: ".nii.gz"
...
| Label | Vertebrae            | Cases | Percentage | Max Volume (cm鲁) | Min Volume (cm鲁) | Median Volume (cm鲁) |
|-------|----------------------|-------|------------|------------------|------------------|---------------------|
...
@article{Sekuboyina2021,
  ...
  author={Sekuboyina, Anjany and Husseini, Malek E and Bayat, Amirhossein and L枚ffler, Maximilian and Liebl, Hans and Li, Hongwei and Tetteh, Giles and Kuka膷ka, Jan and Payer, Christian and 艩tern, Darko and others},
