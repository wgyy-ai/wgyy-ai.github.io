...
dataset_path: "1-Dataset/MAPLES-DR.md"
dimensions: "2D"
modality: "Fundus"
task_type: "Segmentation"
anatomical_structures: "Retina"
anatomical_area: "Head and Neck"
number_of_categories: "12"
data_volume: "198"
file_format: "JPG"
source_url: "https://www.nature.com/articles/s41597-024-03739-6?_gl=1"
...
| Vessels             | 琛€绠?             |
| Exudates            | 娓楀嚭鐗?            |
| CottonWoolSpots     | 妫夌姸鏂戠偣            |
| Drusens             | 鐜荤拑鑶滅枺鏄?          |
| Microaneurysms      | 寰姩鑴夌槫            |
| Hemorrhages         | 鍑鸿              |
| Neovascularization  | 鏂扮敓琛€绠?           |
| RedUncertains       | 涓嶇‘瀹氱孩鑹茬梾鍙?        |
| BrightUncertains    | 涓嶇‘瀹氱櫧鑹茬梾鍙?        |
...
**annotations/**: Stores 12 subfolders (one for each biomarker), each containing all 200 segmented images annotated by the retinal experts, without distinction between training, test, and duplicate sets. Images are stored as PNG binary masks at the resolution used during annotation (1500脳1500 pixels), using the regions of interest (ROIs) provided in MESSIDOR-ROIs.csv.

**MESSIDOR-ROIs.csv**: Provides bounding boxes extracted from MESSIDOR images to obtain square regions of interest that minimize the blank margins around the circular fundus area. For each image identified by name, the bounding box is stored as a pair of pixel coordinates for the top-left (x0, y0) and bottom-right (x1, y1). These coordinates are necessary for padding and resizing the maps in annotations/ and pre_annotations/ to match MESSIDOR鈥檚 resolution, or conversely, for cropping and resizing MESSIDOR images to match the 1500脳1500 resolution of MAPLES-DR segmentation images.
...
Gabriel Lepetit-Aimon (Department of Computer and Software Engineering, Polytechnique Montr茅al, Montr茅al, QC, Canada)

Cl茅ment Playout (Department of Ophthalmology, Universit茅 de Montr茅al, Montr茅al, Canada; Centre Universitaire d鈥橭phtalmologie, H么pital Maisonneuve-Rosemont, Montr茅al, Canada)

Marie Carole Boucher (Department of Ophthalmology, Universit茅 de Montr茅al, Montr茅al, Canada; Centre Universitaire d鈥橭phtalmologie, H么pital Maisonneuve-Rosemont, Montr茅al, Canada)

Renaud Duval (Department of Ophthalmology, Universit茅 de Montr茅al, Montr茅al, Canada; Centre Universitaire d鈥橭phtalmologie, H么pital Maisonneuve-Rosemont, Montr茅al, Canada)

Michael H. Brent (Department of Ophthalmology and Vision Science, University of Toronto, Toronto, Canada)

Farida Cheriet (Department of Computer and Software Engineering, Polytechnique Montr茅al, Montr茅al, QC, Canada)
