---
dataset_entry: true
dataset_name: "SLICE-3D"
dataset_path: "1-Dataset/SLICE-3D.md"
dimensions: "2D"
...
data_volume: "401,059"
file_format: "JPG"
source_url: "https://challenge2024.isic-archive.com/"
...
|-------------|-----------------------|-------------------|
| Melanoma    | Invasive Melanoma     | 渚佃鎬ч粦鑹茬礌鐦?  |
| Basal       | Basal Cell Carcinoma  | 鍩哄簳缁嗚優鐧?      |
| Squamous    | Squamous Cell Carcinoma | 槌炵姸缁嗚優鐧?    |
| Solar       | Solar or Actinic Keratosis | 鏃ュ厜鎬ц鍖栫梾 |
| ...         | ...                   | ...               |
| Benign      | Benign NOS            | 鏈壒鎸囩殑鑹€?    |
...
- Brian M. D鈥橝lessandro (Canfeld Scientific, Inc.)
...
- Josep Malvehy (Hospital Cl铆nic Barcelona, Universitat de Barcelona, IDIBAPS)
...
- Laura Serra-Garc铆a (Hospital Cl铆nic Barcelona)
...
@article{kurtansky2024slice,
  ...
  author={Kurtansky, Nicholas R and D鈥橝lessandro, Brian M and Gillis, Maura C and Betz-Stablein, Brigid and Cerminara, Sara E and Garcia, Rafael and Girundi, Marcela Alves and Goessinger, Elisabeth Victoria and Gottfrois, Philippe and Guitera, Pascale and others},
