---
dataset_entry: true
dataset_name: AMOS 2022
dataset_path: 1-Dataset/AMOS.md
dimensions: 3D
modality: CT, MRI
task_type: Segmentation
anatomical_structures: Spleen, Right Kidney, Left Kidney, Gallbladder, Esophagus, Liver, Stomach, Aorta, Inferior Vena Cava, Pancreas, Right Adrenal Gland, Left Adrenal Gland, Duodenum, Bladder, Prostate/Uterus
anatomical_area: Abdomen
number_of_categories: "15"
data_volume: 240 for training, 120 for validation, 240 for test
file_format: .nii.gz
source_url: https://amos22.grand-challenge.org/
publication_date: ""
tags:
  - dataset
---
...
| Organ/Tissue        | Voxel Ratio (min) | Voxel Ratio (median) | Voxel Ratio (mean) | Voxel Ratio (max) | Actual Size cm鲁 (min) | Actual Size cm鲁 (median) | Actual Size cm鲁 (mean) | Actual Size cm鲁 (max) | Number of Instances |
|---------------------|-------------------|----------------------|--------------------|-------------------|-----------------------|--------------------------|------------------------|-----------------------|---------------------|
