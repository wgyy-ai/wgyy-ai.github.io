...
dataset_entry: true
dataset_name: "M&Ms"
dataset_path: "1-Dataset/M&Ms.md"
dimensions: "3D"
modality: "CMR"
task_type: "Segmentation"
anatomical_structures: "Left and right ventricles, myocardium"
anatomical_area: "Heart"
number_of_categories: "3"
data_volume: "375"
file_format: ".nii.gz"
source_url: "https://www.ub.edu/mnms/"
...
| 2. Cl铆nica Sagrada Familia                 | Barcelona | Spain   |
| 3. Universit盲tsklinikum Hamburg-Eppendorf  | Hamburg   | Germany |
| 4. Hospital Universitari Dexeus            | Barcelona | Spain   |
| 5. Cl铆nica Creu Blanca                     | Barcelona | Spain   |
...
V铆ctor M. Campello (University of Barcelona, Spain)  

Karim Lekadir (University of Barcelona, Spain)  

**Clinical Team**  

Jos茅 F. Rodr铆guez Palomares (Vall d'Hebron Hospital, Spain)
...
Ersin 脟avu艧 (University Hospital Hamburg, Germany)  
...
Mart铆n Descalzo (Hospital de Sant Pau i Santa Creu, Spain)  

David Vilad茅s (Hospital de Sant Pau i Santa Creu, Spain)
