...
dataset_entry: true
dataset_name: "DRIVE"
dataset_path: "1-Dataset/DRIVE.md"
dimensions: "2D"
modality: "Retinal Image"
task_type: "Segmentation"
anatomical_structures: "Fundus blood vessels"
anatomical_area: "Eye"
number_of_categories: "1"
data_volume: "20 for training, 20 for test"
file_format: ".tif / .gif"
source_url: "https://drive.grand-challenge.org/"
publication_date: "2004.4"
tags:
  - dataset
---
# DRIVE
...
*锛歄nly the training set is labeled, and only the training set is counted.
...
Michael D. Abr脿moff (Department of Ophthalmology and Visual Sciences, University of Iowa)
