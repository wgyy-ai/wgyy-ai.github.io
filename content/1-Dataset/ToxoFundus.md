---
dataset_entry: true
dataset_name: "ToxoFundus"
dataset_path: "1-Dataset/ToxoFundus.md"
dimensions: "2D"
modality: "Fundus Color Photos"
...
data_volume: "412"
file_format: "JPG"
source_url: "https://www.kaggle.com/datasets/nafin59/ocular-toxoplasmosis-fundus-images-dataset"
...
Julio C茅sar Mello-Rom谩n (National University of Paraguay)

Jos茅 Luis V谩zquez Noguera (Department of Computer Engineering, American University of Paraguay)

Miguel Garc铆a-Torres (Data Science and Big Data Lab, Pablo de Olavide University, Seville)
...
Jacques Facon (Department of Computer and Electronic Engineering, Federal University of Esp铆rito Santo, Brazil)

Veronica Elisa Castillo Ben铆tez (Ophthalmology Department, Cl铆nicas Hospital, Faculty of Medical Sciences, National University)

Ingrid Castro Matto (Ophthalmology Department, Cl铆nicas Hospital, Faculty of Medical Sciences, National University)

Diego Aquino-Br铆tez (Department of Computer Engineering, American University of Paraguay)
...
author = {Olivia Cardozo and Verena Ojeda and Rodrigo Parra and Julio C茅sar Mello-Rom谩n and Jos茅 Luis {V谩zquez Noguera} and Miguel Garc铆a-Torres and Federico Divina and Sebastian A. Grillo and Cynthia Villalba and Jacques Facon and Veronica Elisa {Castillo Ben铆tez} and Ingrid {Castro Matto} and Diego Aquino-Br铆tez},
