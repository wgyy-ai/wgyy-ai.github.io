...
| Region               | Number of Cases | Completion Rate | Minimum Volume (cm鲁) | Median Volume (cm鲁) | Maximum Volume (cm鲁) |
|----------------------|-----------------|-----------------|----------------------|---------------------|----------------------|
...
- Zhihao Chen (University of Burgundy, FEMTO-ST Institute, Franche-Comt茅)
...
- Dominique Ginhac (University of Burgundy, FEMTO-ST Institute, Franche-Comt茅)
- Michel Salomon (University of Burgundy, FEMTO-ST Institute, Franche-Comt茅)
- Rapha毛l Couturier (University of Burgundy, FEMTO-ST Institute, Franche-Comt茅)
