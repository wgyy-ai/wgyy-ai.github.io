...
anatomical_structures: "cervical vertebra, thoracic, lumbar spine"
anatomical_area: "Vertebrae"
number_of_categories: "25"
data_volume: "610 for training, 197 for validation, 198 for test."
file_format: ".nii.gz"
source_url: "https://github.com/MIRACLE-Center/CTSpine1K"
...
| Label | Anatomy Structure       | Detection Count | Detection Rate | Min Volume (cm鲁) | Median Volume (cm鲁) |
|-------|-------------------------|-----------------|----------------|------------------|---------------------|
