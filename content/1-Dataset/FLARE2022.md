...
anatomical_structures: "Kidney, Liver, Pancreas, Spleen, Stomach, Esophagus, Duodenum, Adrenal Gland."
anatomical_area: "Abdomen"
number_of_categories: "13"
data_volume: "50 annotated, 2000 unannotated for training; 50 for validation; 200 for test"
file_format: ".nii.gz"
...
| Categories    | Coverage Min (%) | Coverage Mean (%) | Coverage Max (%) | Actual Size Min (cm鲁) | Actual Size Mean (cm鲁) | Actual Size Max (cm鲁) | Number of Samples |
|---------------|------------------|-------------------|------------------|-----------------------|-------------------|------------------|-------------------|
...
``` 
@article{FLARE22,
    author = {Jun Ma and Yao Zhang and Song Gu and Cheng Ge and Shihao Ma and Adamo Young and Cheng Zhu and Kangkang Meng and Xin Yang and Ziyan Huang and Fan Zhang and Wentao Liu and YuanKe Pan and Shoujin Huang and Jiacheng Wang and Mingze Sun and Weixin Xu and Dengqiang Jia and Jae Won Choi and Nat谩lia Alves and Bram de Wilde and Gregor Koehler and Yajun Wu and Manuel Wiesenfarth and Qiongjie Zhu and Guoqiang Dong and Jian He and the FLARE Challenge Consortium and Bo Wang},
