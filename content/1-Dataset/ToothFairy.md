---
dataset_entry: true
dataset_name: "ToothFairy"
dataset_path: "1-Dataset/ToothFairy.md"
dimensions: "3D"
modality: "CBCT"
task_type: "Segmentation"
anatomical_structures: "Inferior Alveolar Nerve"
anatomical_area: "Head"
number_of_categories: "1"
data_volume: "443"
file_format: ".npy"
source_url: "https://toothfairy.grand-challenge.org/toothfairy/"
...
<p style="text-align:center;font-size:10px;"><em> Perspective 1 of DATA78锛圠eft: image, Right: label锛?/em></p>

<div align="center">
    <a href="https://github.com/openmedlab/"><img width="700px" height="auto" src="appendix/ToothFairy_3.webp"></a>
</div>
<p style="text-align:center;font-size:10px;"><em> Perspective 2 of DATA78锛圠eft: image, Right: label锛?/em></p>

<div align="center">
    <a href="https://github.com/openmedlab/"><img width="700px" height="auto" src="appendix/ToothFairy_4.webp"></a>
</div>
<p style="text-align:center;font-size:10px;"><em> Perspective 3 of DATA78锛圠eft: image, Right: label锛?/em></p>
