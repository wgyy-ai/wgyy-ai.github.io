---
dataset_entry: true
dataset_name: "MICCAI2024-AutoPETIII"
dataset_path: "1-Dataset/AutoPETIII.md"
dimensions: "3D"
modality: "CT, PET"
...
data_volume: "1614"
file_format: ".nii.gz"
source_url: "https://autopet-iii.grand-challenge.org/task/"
...
<p style="text-align:center;font-size:10px;"><em>Two different PET/CT training datasets: one is a large annotated FDG-PET/CT dataset collected at the University Hospital T眉bingen (UKT) in Germany, and the other is a large annotated PSMA-PET/CT dataset collected at the LMU Hospital in Munich, Germany.</em></p>
