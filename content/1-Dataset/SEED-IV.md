...
dataset_path: "1-Dataset/SEED-IV.md"
dimensions: ""
modality: ""
task_type: ""
...
- **Participants**: 15 healthy Chinese participants (7 males and 8 females, aged 18鈥?0 years).  
...
- **Film Clips**: 24 clips per experiment, resulting in 1080 emotion samples (15 participants 脳 3 experiments 脳 24 clips)  
...
**`eeg_raw_data` Folder**  
- **File Naming Format**: Each participant鈥檚 data for each experiment is stored in a `.mat` file with the format `{SubjectName}_{Date}.mat`.  
- **File Content**:  
...
- **File Content**:  
  ...
  - Each field has dimensions: **Channels 脳 Time Windows 脳 Frequency Bands**, i.e., **62 脳 W 脳 5**.  
...
- **File Naming**: Each `.mat` file corresponds to one participant鈥檚 data for one experiment.  
- **File Content**:  
