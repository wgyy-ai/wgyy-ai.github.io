...
data_volume: ""
file_format: ""
source_url: "https://www.imageclef.org/2019/medical/vqa/"
publication_date: "2019.9"
tags:
  - dataset
---
...
ImageClef-2019-VQA-Med is a unique dataset specifically designed for medical visual question answering tasks, comprising 4,200 carefully selected radiological images and 15,292 meticulously prepared question-answer pairs. The dataset focuses on four key clinical question areas鈥攎odality, plane, organ system, and abnormality鈥攅ach thoughtfully designed to encompass varying levels of difficulty and using categorization and text generation methodologies. The design of these questions ensures that they can be answered directly through the visual content of the images, without relying on additional medical knowledge or domain-specific reasoning.
...
M眉ller, Henning is associated with the University of Applied Sciences and Arts Western Switzerland (HES-SO Valais-Wallis) and the University of Geneva, Switzerland.
