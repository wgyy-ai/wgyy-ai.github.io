---
dataset_entry: true
dataset_name: "L2R-OASIS"
dataset_path: "1-Dataset/L2R-OASIS.md"
dimensions: "3D"
modality: "MR"
task_type: "Registration, Segmentation"
anatomical_structures: "Brain"
anatomical_area: "Head and Neck"
number_of_categories: "35"
data_volume: "416"
file_format: ".nii.gz"
source_url: "https://learn2reg.grand-challenge.org/Datasets/"
...
| Label                                 | Cases | Percentage | Max Volume (cm鲁) | Min Volume (cm鲁) | Median Volume (cm鲁) |
|---------------------------------------|-------|------------|------------------|------------------|---------------------|
...
@article{marcus2007open,
  ...
  pages={1498--1507},
  year={2007},
  publisher={MIT Press One Rogers Street, Cambridge, MA 02142-1209, USA journals-info~鈥
}
```
