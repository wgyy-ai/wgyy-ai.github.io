...
dataset_path: "1-Dataset/Teeth3DS.md"
dimensions: "3D"
modality: "IOS"
task_type: "Segmentation, Labeling"
anatomical_structures: "Teeth, gingiva"
anatomical_area: "Oral cavity"
number_of_categories: "33"
data_volume: "1,800 scans"
file_format: ".obj, .json, .stl"
source_url: "https://github.com/DCBIA-OrthoLab/3DTeethSeg22_challenge"
...
|------------|----------|-----------|-----------------------|-----------------|----------------------|-------------|-------------|
| 3D | IOS | Segmentation, Labeling | Teeth, gingiva | Oral cavity | 33 | 1,800 scans | .obj, .json, .stl |
...
Aur茅lien Thollot (FACS Digital Research Center)
