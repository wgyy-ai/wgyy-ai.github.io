---
dataset_entry: true
dataset_name: "TotalSegmentator MRI"
dataset_path: "1-Dataset/TotalSegmentator_MRI.md"
dimensions: "3D"
modality: "MRI"
task_type: "Segmentation"
anatomical_structures: "56 body structures"
anatomical_area: "Entire body"
number_of_categories: "56"
data_volume: "298"
file_format: ".nii.gz"
...
| Label | Structure                         | Cases | Percentage | Max Volume (cm鲁) | Median Volume (cm鲁) |
|-------|-----------------------------------|-------|------------|------------------|---------------------|
...
Tugba Akinci D鈥橝ntonoli (University Hospital Basel, Switzerland)
...
Jakob Wei脽 (University Medical Center Freiburg, Germany)
...
Thomas K眉stner (University Hospital of Tuebingen, Germany)
...
@misc{dantonoli2024totalsegmentator,
      ...
      author={Tugba Akinci D'Antonoli and Lucas K. Berger and Ashraya K. Indrakanti and Nathan Vishwanathan and Jakob Wei脽 and Matthias Jung and Zeynep Berkarda and Alexander Rau and Marco Reisert and Thomas K眉stner and Alexandra Walter and Elmar M. Merkle and Martin Segeroth and Joshy Cyriac and Shan Yang and Jakob Wasserthal},
      year={2024},
      eprint={2405.19492},
      archivePrefix={arXiv},
