...
dataset_entry: true
dataset_name: "ROSE"
dataset_path: "1-Dataset/ROSE.md"
dimensions: "2D"
modality: "OCTA"
task_type: "Segmentation"
anatomical_structures: "Fundus Vessel"
anatomical_area: "Fundus"
number_of_categories: "1"
data_volume: "229"
file_format: ".png .tif"
source_url: "https://imed.nimte.ac.cn/dataofrose.html"
...
The ROSE-1 dataset includes 117 OCTA images from 39 subjects (26 Alzheimer's patients and 13 healthy subjects). The dataset is divided into 90 images for training and 27 images for testing. Each subject has en face (horizontal cross-sectional) angiograms of the superficial vascular complex (SVC), deep vascular complex (DVC), and the inner retinal vascular plexuses containing both SVC and DVC. The scanning area is a 3脳3 square millimeter region centered around the fovea, with an image resolution of 304脳304 pixels. ROSE-1 provides two different types of vascular annotations: **centerline-level annotations and pixel-level annotations**.

The ROSE-2 dataset contains a total of 112 OCT-A images, with 90 for training and 22 for testing. All images in this dataset are en face angiograms of the SVC within a 3脳3 square millimeter area centered around the fovea. Only centerline-level annotations are provided.
...
The image size for ROSE-1 is 304脳304.

The image size for ROSE-2 is 512脳512.
