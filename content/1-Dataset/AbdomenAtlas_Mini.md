---
dataset_entry: true
dataset_name: AbdomenAtlas 1.0 Mini
dataset_path: 1-Dataset/AbdomenAtlas_Mini.md
dimensions: 3D
modality: CT
task_type: Segmentation
anatomical_structures: Spleen, Liver, Left and Right Kidneys, Stomach, Gallbladder, Pancreas, Aorta, Inferior Vena Cava
anatomical_area: Abdomen
number_of_categories: "9"
data_volume: "5195"
file_format: .nii.gz
source_url: https://github.com/MrGiovanni/AbdomenAtlas
...
| FLARE閳?3             | 13          | 4,000        | 30           | -                        | CC BY-NC-ND 4.0 | 2200                          |
...
| Category        | Occurrence | Percentage | Median Volume (cm椴? | Maximum Volume (cm椴? |
|-----------------|------------|------------|---------------------|----------------------|
