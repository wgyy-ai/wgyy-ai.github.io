...
dataset_entry: true
dataset_name: "BTCV"
dataset_path: "1-Dataset/BTCV.md"
dimensions: "3D"
modality: "CT"
task_type: "Segmentation"
anatomical_structures: "Spleen, right kidney, left kidney, gallbladder, esophagus, liver, stomach, aorta, inferior vena cava, portal and splenic veins, pancreas, right adrenal gland, left adrenal gland"
anatomical_area: "abdomen"
number_of_categories: "13"
data_volume: "30 for training, 20 for test."
file_format: ".nii.gz"
source_url: "https://www.synapse.org/#!Synapse:syn3193805/wiki/"
...
| Organ | Volume Fraction (%) min | Volume Fraction (%) median | Volume Fraction (%) mean | Volume Fraction (%) max | Actual Size (cm鲁) min | Actual Size (cm鲁) median | Actual Size (cm鲁) mean | Actual Size (cm鲁) max | Count of Inclusion |
|-------|-------------------------|----------------------------|--------------------------|-------------------------|------------------------|---------------------------|-------------------------|------------------------|--------------------|
...
@inproceedings{landman2015miccai,
  ...
  booktitle={Proc. MICCAI Multi-Atlas Labeling Beyond Cranial Vault鈥擶orkshop Challenge},
  volume={5},
  pages={12},
  year={2015}
}
