...
dataset_path: "1-Dataset/VQA-RAD.md"
dimensions: ""
modality: ""
task_type: ""
...
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Modality                  | How an image is taken 鈥?CT, x-ray, T2 weighted MRI, etc.                                                                                                                         |
| Plane                     | Orientation of an image slicing through the body 鈥?axial, sagittal, coronal                                                                                                       |
| Organ System              | Categorization that connects anatomical structures with pathophysiology, diagnosis, and treatment 鈥?pulmonary, cardiac, musculoskeletal system                                    |
| Abnormality               | Normalcy of an image or object. For example, 鈥渋s there something wrong with the image?鈥?or 鈥淲hat is abnormal about the lung?鈥? 鈥淒oes the liver look normal?鈥?                    |
| Object/Condition Presence | Objects could be normal structures like organs or body parts but could also be abnormal objects such as masses or lesions. Clinicians may refer to the presence of conditions in an image or patient 鈥?fractures, midline shift, infarction |
...
| Answer Type               |                                                                                                                                                                                  |
| Close-ended               | yes/no and other limited choices. For example, 鈥淚s the mass on the left or right?鈥?                                                                                               |
